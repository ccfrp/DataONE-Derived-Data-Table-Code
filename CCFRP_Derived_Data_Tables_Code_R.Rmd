...
author: "Rachel Brooks, Shelby Zeigler, Ryan Fields"
date: "05/09/2022"
output:
...
Load 'Raw' formats of the tables. These are .csv versions of the Access database 
tables. These are exactly as they are exported from Access - i.e.  Column names 
are not changed until it gets to R. The following .csv data tables used for 
analysis can be accessed through the CCFRP GIT HUB:

CCFRP GIT HUB LINK HERE
...
trip.data.raw = read.csv("CSV_Files/1-Trip Information.csv")

#3-Drift Information Table
#Included bit to make any blanks change to 'NA'
drift.data.raw = read.csv("CSV_Files/3-Drift Information.csv", na = c("", "NA")) 

#4-Caught Fishes Table
fishes.caught.raw = read.csv("CSV_Files/4-Caught Fishes.csv")


#Fish codes to match species code with common name
fish.codes = read.csv("CSV_Files/Fish Species.csv")

#Length weight relationships
length.weight = read.csv("CSV_Files/CCFRP_Biomass_Conversion_20220206.csv")

#OPC MPA Designation Info
CCFRP_location_table <- read.csv("CSV_Files/CCFRP_location_table.csv")
